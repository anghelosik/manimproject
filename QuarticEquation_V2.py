...
class QuarticEquation_V2(Scene):
    def construct(self):
        # Titolo
        ...
        # Spostiamo in alto
        self.play(eq_initial.animate.scale(0.85).next_to(title, DOWN, buff=0.8))
        ...
        step2_text = Text("Raggruppiamo i primi tre termini:", 
                         font_size=26, color=YELLOW)
        ...
        subst_title = Text("Sostituzione: metodo quadratico", font_size=32, color=YELLOW)
        ...
        solutions.move_to(ORIGIN).shift(DOWN*0.3)  # Spostato più in basso
        ...
        # Nota finale - POSIZIONATA IN BASSO PER NON COPIRE IL TITOLO
        note = Text("Buon anno 2026", 
                   font_size=22, color=GRAY)
        note.to_edge(DOWN, buff=0.5)  # Spostata in basso
